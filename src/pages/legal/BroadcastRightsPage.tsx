...
const BroadcastRightsPage = () => (
  <LegalLayout title="Derechos de transmisión" description="Cómo gestionamos los derechos de retransmisión deportiva.">
    <p>Arena Live Sports sólo emite eventos cuando cuenta con los derechos correspondientes o cuando el creador autoriza la difusión a través de un proveedor licenciado.</p>
