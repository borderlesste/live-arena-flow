  ...
  return (
    <section className="container mx-auto grid min-h-[60vh] place-items-center px-4 py-16 text-center">
      <div className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">La ruta <code className="rounded bg-surface-2 px-1 py-0.5">{loc.pathname}</code> no existe en Arena Live Sports.</p>
        <div className="flex flex-wrap items-center justify-center gap-2">
          <Button asChild className="bg-gradient-primary text-primary-foreground"><Link to="/"><Home className="mr-1.5 h-4 w-4" /> Volver al inicio</Link></Button>
