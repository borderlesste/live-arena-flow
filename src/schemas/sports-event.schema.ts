...
export const normalizedSportsEventSchema = z.object({
  id: z.string(), startsAt: z.string().datetime(), sport: z.string(),
  ...
  statusLabel: z.string().optional(), venue: z.string().optional(), city: z.string().optional(), highlightUrl: z.string().url().optional(),
});
